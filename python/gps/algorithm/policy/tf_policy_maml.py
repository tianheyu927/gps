...
class TfPolicyMAML(Policy):
    ...
    def __init__(self, dU, obsa, statea, actiona, obsb, stateb, act_opa, act_op, reference_op, reference_out, feat_op, image_op, norm_type, var, sess, graph, device_string, copy_param_scope=None):
