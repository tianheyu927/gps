...
class TfMap:
    ...
    def __init__(self, input_tensor, target_output_tensor, precision_tensor, output_op, test_output_op, loss_op, fp=None, image=None, debug=None, random_seed=0):
    ...
    def init_from_lists(cls, inputs, outputs, loss, fp=None, image=None, debug=None, random_seed=0):
        ...
        return cls(inputs[0], inputs[1], inputs[2], outputs[0], outputs[1], loss[0], fp=fp, image=image, debug=debug, random_seed=random_seed)
